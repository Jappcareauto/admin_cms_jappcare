...
const NewServiceForm = lazy(() => import('../../components/Drawer/serviceForm/NewServiceForm'));
const AppointmentDetails = lazy(() => import('../../components/Drawer/appointmentDetails/AppointmentDetails'));
...
const Dashboard = () => {
   ...
   const renderAppointmentCard = (appointment: AppointmentInterface) => {
    ...
    return (
        <Box sx={{ p: { xs: 1, sm: 2, md: 3 }, minHeight: '100vh', overflowX: 'hidden' }}>
                                    ...
                                    {serviceData.map((service, index) => (
                                        <ServiceItem key={service.id}>
                                            ...
                                            <Box
                                                ...
                                                alt={service.title}
                                                sx={{ width: { xs: '100%', sm: 200 }, maxWidth: 200, height: 120, objectFit: 'cover', borderRadius: 2 }}
                                            />
                                        </ServiceItem>
                                    ))}
                                </Stack>
