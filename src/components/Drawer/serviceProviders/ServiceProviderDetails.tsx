...
import { Alert, IconButton, CircularProgress, Chip, Autocomplete, FormControlLabel, Switch } from '@mui/material';
...
const ServiceProviderDetails = ({ serviceProviderId, initialEditMode = false, onSeeStatistics, onClose }: ServiceProviderDetailsProps) => {
